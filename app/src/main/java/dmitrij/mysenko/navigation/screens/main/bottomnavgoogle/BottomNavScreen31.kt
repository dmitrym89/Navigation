...
@Composable
fun BottomNavScreen31(rootNavController: NavController, navHostController: NavController) {
    Column(
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.BottomNavScreen32.makeRoute(NestedGraph.BottomNav3))
            },
