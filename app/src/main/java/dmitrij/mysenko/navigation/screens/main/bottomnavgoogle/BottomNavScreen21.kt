...
@Composable
fun BottomNavScreen21(rootNavController: NavController, navHostController: NavController) {
    Column(
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.BottomNavScreen22.makeRoute(NestedGraph.BottomNav2))
            },
