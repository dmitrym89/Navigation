...
fun BottomNavYoutubeScreen41(
    ...
    Column(
        ...
        BackHandler {
            backClick.invoke(NestedGraph.BottomNavYoutube4)
        }
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.BottomNavYoutubeScreen42.makeRoute(NestedGraph.BottomNavYoutube4))
            },
