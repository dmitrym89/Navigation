...
fun BottomNavYoutubeScreen11(
    ...
    Column(
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.BottomNavYoutubeScreen12.makeRoute(NestedGraph.BottomNavYoutube1))
            },
