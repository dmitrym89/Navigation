...
fun DrawerImageScreen(
    ...
    Column(
        ...
        Button(
            onClick = {
                navHostController.backQueue.removeIf{entry -> entry.destination.route?.endsWith(Screen.DrawerUserScreen.route) == true}
                navHostController.navigate(Screen.DrawerUserScreen.makeRoute(graph))
            },
