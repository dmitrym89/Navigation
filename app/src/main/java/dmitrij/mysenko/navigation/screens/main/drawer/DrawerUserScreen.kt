...
fun DrawerUserScreen(
    ...
    Column(
        ...
        Button(
            onClick = {
                navHostController.backQueue.removeIf{entry -> entry.destination.route?.endsWith(Screen.DrawerImageScreen.route) == true}
                navHostController.navigate(Screen.DrawerImageScreen.makeRoute(graph))
            },
