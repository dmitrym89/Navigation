...
@Composable
fun DrawerLatestScreen(rootNavController: NavController, navHostController: NavController) {
    Column(
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.DrawerUserScreen.makeRoute(NestedGraph.DrawerLatest))
            },
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.DrawerImageScreen.makeRoute(NestedGraph.DrawerLatest))
            },
            modifier = Modifier.fillMaxWidth(0.8f)
        ) {
