...
fun BottomNavYoutubeScreen21(
    ...
    BackHandler {
        backClick.invoke(NestedGraph.BottomNavYoutube2)
    }
    ...
    Column(
        ...
        Button(
            onClick = {
                navHostController.navigate(Screen.BottomNavYoutubeScreen22.makeRoute(NestedGraph.BottomNavYoutube2))
            },
